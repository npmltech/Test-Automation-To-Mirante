...
Funcionalidade: Validar a API Person
  ...
  @api_cn_c1 @allure.label.severity:critical @allure.label.story:api_cn_c1
  ...
  @api_cn_c2 @allure.label.severity:critical @allure.label.story:api_cn_c2
  ...
  @api_cn_c3 @allure.label.severity:normal @allure.label.story:api_cn_c3
  ...
  @api_cn_c4 @allure.label.severity:normal @allure.label.story:api_cn_c4
  ...
  @api_cn_c5 @allure.label.severity:normal @allure.label.story:api_cn_c5
