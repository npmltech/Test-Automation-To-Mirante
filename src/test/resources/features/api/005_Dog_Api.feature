...
Funcionalidade: Validar a integração com a Dog API
  ...
  @api_cn_e2 @allure.label.severity:critical @allure.label.story:api_cn_e2
  ...
  @api_cn_e3 @allure.label.severity:critical @allure.label.story:api_cn_e3
  ...
  @api_cn_e4 @allure.label.severity:critical @allure.label.story:api_cn_e4
  ...
  @api_cn_e5 @allure.label.severity:critical @allure.label.story:api_cn_e5
